...
-- 
-- NOTE: This configuration uses the new vim.lsp.config() API (Neovim 0.11+)
-- We keep nvim-lspconfig installed for plugin compatibility (typescript-tools, etc.)
-- but use vim.lsp.config() in our own setup to avoid deprecation warnings.

local M = {}

function M.setup()
  -- Configure all LSP floating windows to have borders
  ...
  vim.api.nvim_create_autocmd('LspAttach', {
    ...
    callback = function(event)
      ...
      -- Turns on the hover information for what's under your cursor.
  ...
  for server_name, server_config in pairs(servers) do
    ...
    -- Use the new vim.lsp.config() function instead of the old framework
    vim.lsp.config(server_name, config)
  end

  -- Enable additional servers directly
